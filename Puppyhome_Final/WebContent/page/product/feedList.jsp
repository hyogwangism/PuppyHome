...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/page/product/css/feedList.css"/>
						...
						<div class="product_kind_button">
							<ul class="menuCategory">
								...
								<li style="display:;"
									...
									href="/category/브랜드별/25/">어덜트 <span
