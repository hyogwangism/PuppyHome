...
<div>
  ...
  <form action="cs_addFAQOK.shop" method="post">
   <table class="inquire-table">
    <tr>
		<th>구분</th>
		<td>
		<select name="faq_category"  style="width:500px;height:30px;">
    ...
    <tr>
    <th>제목</th>
    <td><input type="text" class="rag-title" name="faq_title" placeholder="제목을 입력하세요"></td>
    </tr>
    <tr>
     <th>문의내용</th>
     <td>
       <!-- <textarea placeholder="문의내용을 입력해주세요." maxlength="2000" rows="6" id="texts" spellcheck="false"></textarea> -->
        <textarea id="faq_cont" class="summernote" name="faq_cont" rows="10" cols="65"></textarea>      
     </td>
    </tr>
    ...
    <div class="flex-box">
        ...
        <button type="reset" id="button1" class="btn-default" onclick="location='cs_FAQ.shop';">취소</button> 
      </div>
    </td>
    </tr>
