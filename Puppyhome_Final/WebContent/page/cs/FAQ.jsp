...
<div>
 ...
 <ul id="label">
  <li><input type="text" value="로그인/정보" id="faq_category" size="10" onclick="location='cs_FAQ.shop?faq_category=로그인/정보';" readonly /></li>
  <li><input type="text" value="상품" id="faq_category" size="6" onclick="location='cs_FAQ.shop?faq_category=상품';" readonly /></li>
  <li><input type="text" value="주문/결제" id="faq_category" size="8" onclick="location='cs_FAQ.shop?faq_category=주문/결제';" readonly /></li>
  <li><input type="text" value="배송문의" id="faq_category" size="8" onclick="location='cs_FAQ.shop?faq_category=배송문의';" readonly /></li>
  <li><input type="text" value="교환/취소(반품)" id="faq_category" size="12" onclick="location='cs_FAQ.shop?faq_category=교환/취소(반품)';" readonly /></li>
 </ul>
</div>
<br>
...
<div class="btn_contact">
 <form action="">
   <button type="button" class="btn_1" onclick="location='cs_addFAQ.shop';">FAQ 추가</button>
 </form>
</div>
</c:if>
</section>
